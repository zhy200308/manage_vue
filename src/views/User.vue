<template>
  <div>
    ...
    <div style=" padding: 10px 0;">
      <el-button type="success" size="small"><i class="el-icon-download" style="margin-right: 6px" ></i>导出</el-button>
      <el-button type="warning" size="small"><i class="el-icon-upload2" style="margin-right: 6px"></i>导入</el-button>
      <!--              气泡弹窗-->
      <el-popconfirm
    ...
    >
      ...
      <el-table-column prop="creatTime" label="日期" width="160" >
        <template v-slot="scope">{{ scope.row.creatTime }}</template>
      </el-table-column>
      ...
      <el-table-column>
        <template v-slot="scope">
          ...
          <!--              <el-button @click="handleClick(scope.row)" type="primary" size="mini"><i class="el-icon-view"></i>查看</el-button>-->
          <!--              气泡弹窗-->
          <el-popconfirm
              style="margin-left: 5px"
              confirm-button-text='确定'
    ...
    <!--        超级管理员信息增加弹窗-->
    <el-dialog title="用户信息" v-model:visible="dialogFormVisible" width="25%" >
...
export default {
  ...
  methods:{
    ...
    save(){this.$request.post("/user",this.form).then(res =>{
      if (res){
